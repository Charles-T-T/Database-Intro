...
- 属性
  ...
  - $n$ 目关系必有 $n$ 个属性
    ...
    > *e.g.* 
    >
    > **SMP(SUPER,  MAJOR, POSTGRADUATE)** 有3个属性，是一个3目关系；（张清玫，计算机科学与技术，李勇），（张清玫，信息管理与信息系统，刘晨），(刘逸，信息管理与信息系统，王敏) 是**SMP**关系的3个元组
...
> *e.g.*
>
> 在导师-研究生关系**SMP(SUPERVISOR, MAJOR, <u>POSTGRADUATE</u>)**中，假设研究生不能重名，则**POSTGRADUATE**可以作为关系**SMP**的主码，用<u>下划线</u>表示
...
- 实体完整性和参照完整性
  - 关系模型必须满足的完整性约束条件称为关系的 **两个不变性** ，应该由关系系统 **自动支持** 
- 用户定义的完整性
